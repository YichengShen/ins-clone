            ...
            <article className={css.postContent}>
                ...
                <div className={css.indent}>
                    <div className={css.likeCommentIcons}>
                        {
                            props.likes.self ? 
                            <img className={css.iconItem} 
                                src={publicUrl('/assets/unlike.svg')} alt="Unlike"
                                onClick={handleUnlike}
                            /> : 
                            <img className={css.iconItem} 
                                src={publicUrl('/assets/like.svg')} alt="Like"
                                onClick={handleLike}
                            />
                        }
                        <button onClick={e=>setToggleComment(!toggleComment)}>
                            <img className={css.iconItem} src={publicUrl('/assets/comment.svg')} alt="Comment Action"/>
                        </button>
                    </div>
                    ...
                    <div className={css.time}>{timespan(props.post.datetime).toUpperCase()} AGO</div>
